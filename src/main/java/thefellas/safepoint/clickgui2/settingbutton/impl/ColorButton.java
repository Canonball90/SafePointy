package thefellas.safepoint.clickgui2.settingbutton.impl;
...
public class ColorButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (colorSetting.isOpen()) {
            ...
            RenderUtil.drawRect(x + 1, y + 107, x + 109, y + (colorSetting.isSelected() ? 130 : 120),  new Color(55,55,55, 255).getRGB());
