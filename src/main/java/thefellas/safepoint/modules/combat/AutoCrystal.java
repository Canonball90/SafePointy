...
public class AutoCrystal extends Module {
    ...
    public IntegerSetting range = new IntegerSetting("Range", 4, 1, 6, this);
    public IntegerSetting maxPlayerDamage = new IntegerSetting("Max Player Damage", 10, 1, 20, this);
    public IntegerSetting hitAttempts = new IntegerSetting("Hit Attempts",  2, 1, 5, this);
    ...
    public void onWorldRender() {
        if(targetPos != null) {
            ...
            RenderGlobal.renderFilledBox(box.minX, box.minY, box.minZ, box.maxX, box.maxY, box.maxZ, 1f, 0f, 0f, 1f);
            RenderUtil.release();
        }
    }
