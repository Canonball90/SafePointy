...
import thefellas.safepoint.core.utils.SbarUtils.ICustomSearchHandler;
import thefellas.safepoint.core.utils.SbarUtils.ISearchHandler;

@ModuleInfo(name = "ChestSearchBar", description = "Searches for items in chests", category = Module.Category.Misc)
public class ChestSearchBar extends Module {
    ...
    public static final ResourceLocation GENERAL_ICONS_RESOURCE = new ResourceLocation(SafepointMod.MOD_ID, "textures/misc/general_icons.png");
