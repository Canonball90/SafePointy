...
public class Window {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Safepoint.fontInitializer.draw(name,(x + (width / 2f) - (Safepoint.mc.fontRenderer.getStringWidth(name) / 2f)),(y + (height / 2f) - (Safepoint.mc.fontRenderer.FONT_HEIGHT / 2f)), -1);
        if (isOpened) {
            modules.clear();
            int y = this.y;
