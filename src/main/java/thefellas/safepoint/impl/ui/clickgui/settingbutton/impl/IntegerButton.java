...
public class IntegerButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Safepoint.fontInitializer.draw(integerSetting.getName() + " " + ChatFormatting.GRAY + integerSetting.getValue(), x + 2,(y + (height / 2f) - (Safepoint.mc.fontRenderer.FONT_HEIGHT / 2f)), -1);
    }
