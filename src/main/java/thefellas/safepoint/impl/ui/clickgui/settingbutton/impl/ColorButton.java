...
public class ColorButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Safepoint.fontInitializer.draw(colorSetting.getName(), x + 2, y, -1);
        ...
        if (colorSetting.isOpen()) {
            ...
            Safepoint.fontInitializer.draw(colorSetting.isSelected() ? ChatFormatting.UNDERLINE + hex : hex,(x + 109 / 2f - (Safepoint.mc.fontRenderer.getStringWidth(hex) / 2f)),(y + 109 + (11 / 2f) - (Safepoint.mc.fontRenderer.FONT_HEIGHT / 2f)), -1);
            if (colorSetting.isSelected()) {
                Safepoint.fontInitializer.draw(isInsideCopy(mouseX, mouseY) ? ChatFormatting.UNDERLINE + "Copy" : "Copy",((x + ((107) / 8f) * 2) - (Safepoint.mc.fontRenderer.getStringWidth("Copy") / 2f)), y + 120, -1);
                Safepoint.fontInitializer.draw(isInsidePaste(mouseX, mouseY) ? ChatFormatting.UNDERLINE + "Paste" : "Paste",((x + ((107) / 8f) * 6) - (Safepoint.mc.fontRenderer.getStringWidth("Paste") / 2f)), y + 120, -1);
            }
