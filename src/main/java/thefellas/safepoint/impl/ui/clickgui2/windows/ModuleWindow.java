package thefellas.safepoint.impl.ui.clickgui2.windows;

import net.minecraft.client.audio.PositionedSoundRecord;
import net.minecraft.init.SoundEvents;
import thefellas.safepoint.Safepoint;
import thefellas.safepoint.impl.settings.impl.*;
import thefellas.safepoint.impl.ui.clickgui2.settingbutton.impl.*;
...
public class ModuleWindow {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        RenderUtil.drawRect(x, y, x + width, y + height, new Color(55,55,55, 255).getRGB());
        if (module.isEnabled())
            RenderUtil.drawRect(x, y, x + width, y + height, enabledColor.getRGB());
